#include "board_view_terminal.hpp"
...
namespace chess
{
	...
	void BoardViewTerminal::wait_for_any_key()
	{
	...
	bool BoardViewTerminal::should_close() const
	{
	...
	void BoardViewTerminal::set_board(const chess::Board& _board)
	{
		int _offsetX = 0;
		int _offsetY = 0;
	...
	BoardViewTerminal::BoardViewTerminal(const char* _assetsDirectoryPathStr, bool _step) :
	...
	BoardViewTerminal::~BoardViewTerminal()
	{
		terminal_close();
	};
};
